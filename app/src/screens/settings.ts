...
function walletBody(): (Node | null)[] {
  return [
    ...
    card(
      ...
      h('span', { class: 'muted',
        text: 'You hold your own key. We never hold it and cannot sign anything for you. That is also why we cannot reverse a payment.' }),
      kv('Who holds it', 'You, through Coinbase'),
...
export const GROUPS: Group[] = [
  ...
  { key: 'wallet', label: 'Your wallet', ic: icon.wallet(),
    status: () => 'Base · your key', body: walletBody },
