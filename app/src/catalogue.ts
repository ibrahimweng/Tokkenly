...
export const CATALOGUE: Instrument[] = [
  ...
  { ticker: 'AMZNc', under: 'AMZN', launch: true, chainlinkAge: 34, multiplier: 1.0, actions: [], mark: 179.14, liquidity: 176000, holders: 14300, holdersPct: 3.55, vol24h: 402000, address: '8wYpK4nBvR7tLmJ2cQxH5sZdA9gF3eU6oNrV1yTiXqMb', kind: 'stock', name: 'Amazon', price: 178.5, dayPct: 0.9, yearLow: 118.35, yearHigh: 201.2, dividend: 0, cap: '$1.86T', pe: 42.1, plain: 'The shop, and the cloud that pays for it.', tags: ['Popular'] },
  { ticker: 'VOOc', under: 'VOO', launch: true, chainlinkAge: 18, multiplier: 1.0181, actions: [{ at: '2026-06-27', kind: 'dividend', what: 'Quarterly distribution, $1.78 a share', from: 1.0146, to: 1.0181 }], mark: 511.11, liquidity: 664000, holders: 31200, holdersPct: 5.47, vol24h: 1480000, address: '3nBqL9xVpT6mRcJ8yKwH2sGdF5aZ7eU4tNrX1oPyViWm', kind: 'etf', holds: 500, name: 'S&P 500 ETF', price: 511.57, dayPct: 0.4, yearLow: 398.1, yearHigh: 528.9, dividend: 1.32, cap: '$1.24T', pe: 26.4, plain: 'One holding spread across the five hundred biggest US companies.', tags: ['ETFs', 'Steady'] },
  { ticker: 'QQQc', under: 'QQQ', launch: true, chainlinkAge: 26, multiplier: 1.0044, actions: [{ at: '2026-06-23', kind: 'dividend', what: 'Quarterly distribution, $0.68 a share', from: 1.0029, to: 1.0044 }], mark: 469.19, liquidity: 421000, holders: 19700, holdersPct: 4.02, vol24h: 886000, address: '5xTpM2nBvK8qLcR7yJwH4sZdG9aF6eU3tNrV1oPyXiQb', kind: 'etf', holds: 100, name: 'Nasdaq-100 ETF', price: 468.2, dayPct: 0.8, yearLow: 342.4, yearHigh: 503.5, dividend: 0.58, cap: '$298B', pe: 31.7, plain: 'One holding spread across the hundred biggest on the Nasdaq.', tags: ['ETFs'] },
