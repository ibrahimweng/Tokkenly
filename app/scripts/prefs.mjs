...
await at('/')
// The doors, which only the Simple view draws. It used to look for the words
// "Buy Stocks", which stopped being a door label when every door was made to
// carry the name of the place it opens. Three at this width since 11g.75:
// Wallet is on the rail here, so its door went.
