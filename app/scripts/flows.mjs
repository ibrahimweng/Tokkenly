...
await step('typed 600, button now says: ' + (await text('.card .btn-filled')).trim())
await page.locator('.card .btn-filled').click()
...
await page.locator('.sheet .btn-quiet').click()   // View in History
